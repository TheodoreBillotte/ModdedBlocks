...
/**
 * Called when a custom block is placed by a player.
 * <p>
...
public class CustomBlockPlaceEvent extends CustomBlockEvent implements Cancellable {
    ...
    public CustomBlockPlaceEvent(@NotNull final Block placedBlock, @NotNull final CustomBlock customBlock, @NotNull final BlockState replacedBlockState, @NotNull final Block placedAgainst, @NotNull final ItemStack itemInHand, @NotNull final Player thePlayer, final boolean canBuild, @NotNull final EquipmentSlot hand) {
        super(placedBlock, customBlock);
